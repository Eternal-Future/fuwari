...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "https://static.efur.top/img/2026/05/799d9ba28fdf336ba3804afb9d614dd2.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "小仓库",
			url: "https://res.efur.top/", // Internal links should not include the base path, as it is automatically added
			external: true, // Show an external link icon and will open in a new tab
		},
		{
			name: "Cloudreve",
			url: "https://pan.efur.top/", // Internal links should not include the base path, as it is automatically added
			external: true, // Show an external link icon and will open in a new tab
		},
	],
};
